      ...
      <!-- Datatables -->
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="<?= base_url('Departemen/simpan') ?>" method="POST">
                    <div class="form-group row">
                      <label for="inputtext3" class="col-sm-3 col-form-label">Nama Departemen</label>
                      <div class="col-sm-9">
                        <input name="nama_departemen" type="text" class="form-control" id="inputtext3" placeholder="Dermatologists">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputDeskripsi3" class="col-sm-3 col-form-label">Deskripsi</label>
                      <div class="col-sm-9">
                        <textarea name="deskripsi" class="form-control" id="" cols="30" rows="5" placeholder="Dermatologists focus on diseases and conditions of the skin, nails, and hair. They treat conditions such as eczema, skin cancer, acne, and psoriasis."></textarea>
                      </div>
                    </div><hr>
                    <div class="form-group row">
                      <div class="col-sm-10">
